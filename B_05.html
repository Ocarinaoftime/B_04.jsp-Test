...
var a = new Array();	
	...
	a[-(EC_ERROR_ALREADY_OWN)] = "An error has occurred that cannot be resolved at this time. Please try again later.<BR><BR>Create a Support Post in the Official Reviive Shop Discord Server for assistance if this continues.";
	msg = a[-status];
    	...
    	if (errCode != null && errCode < 0) {
    	    ...
    	    var nhttpStatus = errCodeToNHTTPStatus(errCode);    
      	    if (nhttpStatus == 0 && shop.isCompatibleMode) {
    		    ...
    		    msg = "An error has occurred that cannot be resolved at this time. Please try again later.<BR><BR>Create a Support Post in the Official Reviive Shop Discord Server for assistance if this continues.";
    		}
    	}
    }
...
<title>Details</title>
  <link href="/static/css/B_05.css" rel="stylesheet" type="text/css" />

<script language="JavaScript" src="/static/js//shopsd.js"></script>
<SCRIPT language="JavaScript" src="/static/js//title_manager.js"></SCRIPT>
<script type="text/JavaScript">
<!--  -----------------------------------------------------  -->
<!--  Copyright 2005-2014 Acer Cloud Technology, Inc.        -->
<!--  All Rights Reserved.                                   -->
...
var sdErrorMessage = ['An SD Card process failed.',
                      ...
                      'There is not enough available space in Wii system memory.<BR>Create '+0+' block(s) of free space either by moving data to an SD Card or deleting data in the Wii console&rsquo;s Data Management screen.' ];
<!--
var titleId = '000100014A414A45';
var titleSize = '17006592';
var titleTmdSize = '2528';
...
function showSDSelection()
{
    ...
    setUnderButtonL(true, "Back", "/titleinfopage", "wiiCancelSound()");
...
function doCheckingBalance(giftCheckingFlag) {
	...
	if (requiredPoints > 0 && remainingBalance < 0) {
		...
		if (giftCheckingFlag)
			...
			document.getElementById("pointError").style.display = '';
	} else {
		warningDisplayed = false;
	}
...
function showPurchasePage(){
    ...
    onBuyButtonPressed('000100014A414A45', '');
...
function initPurchaseButtonArea() {
	function setFree(caption) {
		...
		document.getElementById("price").innerHTML = '0 Wii Points';
	}
  ...
  if(shop.isCompatibleMode){
    ...
    if(giftButton == "NULL"){
        ...
        document.getElementById("giftPrice").innerHTML = '0 Wii Points';
    }else{//PRICE
        showElement("giftButton");
    ...
    if(getURLParam("icr") == "true"){//IF come from B_04ICRPAGE
        document.getElementById("BuyAnchor").href = "javascript:onBuyButtonPressed('000100014A414A45', '')";
...
{
    initPageCommon();
    MM_preloadImages('/static/images//banner/under_banner_b.gif',
            '/static/images//banner/help_b.gif',
            '/static/images//banner/top_b.gif',
            '/static/images//banner/buy_b.gif',
            '/static/images//banner/controller_msg2_E_EN.gif',
            '/static/images//banner/B01_halfbanner_a.png',
            '/static/images//banner/B01_halfbanner_b.png',
            '/static/images//banner/sdToSD_a.png',
            '/static/images//banner/sdToSD_b.png',
            '/static/images//banner/sdToNAND_a.png',
            '/static/images//banner/sdToNAND_b.png',
            '/static/images//banner/point_gray.png',
            '/static/images//banner/AgeRating_a.gif',
            '/static/images//banner/AgeRating_b.gif',
            '/static/images//banner/AgeRating_USK_a.gif',
            '/static/images//banner/AgeRating_USK_b.gif');
    ...
    setUnderButtonL(true, "Back", "history.back(1);", "wiiCancelSound()");
...
var icrExactDiscount = '';
    ...
    if (isFreeIntroEnabled=="true")
        setUnderButtonR(true, "More Details", "/B_06?title=", "wiiSelectSound()");
    else
        setUnderButtonR(true, "More Details", "/B_06?title=')", "wiiSelectSound()");
...
<!--  -----------------------------------------------------  -->
  <div id="constElements">
    <div id="tophelpshadow"><img src="/static/images//banner/top_help_shadow01.gif" width="132" height="75" /></div>
  <div id="help">
	<a href="/shopguide" onclick="wiiSelectSound();" onMouseOver="snd.playSE( cSE_Forcus );">
		<img src="/static/images//banner/help_a.gif" name="TopImage" 
		 width="52" height="55" border="0" id="ManualImageID"   onMouseOver="this.src='/static/images/banner/help_b.gif'"  onMouseDown="this.src='/static/images/banner/help_b.gif'" onMouseOut="this.src='/static/images/banner/help_a.gif'"
		 onClick="snd.playSE(cSE_Decide);"/>
		<img src="/static/images//banner/help_b.gif" 
		 width="52" height="55" border="0" id="ManualImageID" style="display:none" />
		<img src="/static/images//spacer.gif" name="MainSpacer" width="52" height="55" border="0"
		 id='MainSpacer' style="position:absolute; top:0px; left:0px; display:none"/>
		</a>
  </div>

  <div id="top">
	<a href="/homepage" onclick="wiiCancelSound();" onMouseOver="snd.playSE( cSE_Forcus );">
    <img src="/static/images//banner/top_a.gif" name="TopImage"  onMouseOver="this.src='/static/images/banner/top_b.gif'"  onMouseDown="this.src='/static/images/banner/top_b.gif'" onMouseOut="this.src='/static/images/banner/top_a.gif'"
     width="52" height="55" border="0" id="TopImageID" 
     />
    <img src="/static/images//banner/top_gray.gif" 
  ...
  <div id='balanceInfo' onclick="wiiSelectSound();"
   ...
   onmouseout="MM_swapImgRestore();">
    ...
    <div id="point" class="wiiPoint"><span id="wiipointsbalance">{{ ptsNB | safe }}</span></div>
  </div>
<!--  -----------------------------------------------------  -->
<!--  Copyright 2005-2014 Acer Cloud Technology, Inc.        -->
<!--  All Rights Reserved.                                   -->
...
<!--  Technology, Inc.                                       -->
<!--  -----------------------------------------------------  -->
<script language="JavaScript">MM_preloadImages('/static/images//banner/under_banner_b.gif');</script>
<div id="underButtonL" style="display:block">
    <div id="underbannershadowL" class="buttonBannerShadow">
   	  <img src="/static/images//banner/under_banner_shadow.gif" width="211" height="75" />
   	</div>
    <div id="underbannerL" class="buttonBanner">
    	<img src="/static/images//banner/under_banner_a.gif" width="187" height="55" id="underImgL" />
    </div>
    <div id="underspacerL" class="buttonSpacer">
	  <a onclick="history.back(1);" id="underlinkL" onmousedown="wiiCancelSound();">
    	<img id="underimageL" src="/static/images//spacer.gif" width="187" height="55" border="0"  
    	onmouseover="MM_swapImage('underImgL','','/static/images//banner/under_banner_b.gif',1); snd.playSE( cSE_Forcus );" 
    	onmouseout="MM_swapImgRestore()"/>
      </a>	
    </div>
...
<div id="underButtonR" style="display:block">
    <div id="underbannershadowR" class="buttonBannerShadow">
   	  <img src="/static/images//banner/under_banner_shadow.gif" width="211" height="75" />
   	</div>
    <div id="underbannerR" class="buttonBanner">
    	<img src="/static/images//banner/under_banner_a.gif" width="187" height="55" id="underImgR" />
    </div>
    <div id="underspacerR" class="buttonSpacer">
	  <a href="/B_06"  id="underlinkR"  onmousedown="wiiSelectSound();">
    	<img id="underimageR" src="/static/images//spacer.gif" width="187" height="55" border="0"  
    	onmouseover="MM_swapImage('underImgR','','/static/images//banner/under_banner_b.gif',1); snd.playSE( cSE_Forcus ); " 
    	onmouseout="MM_swapImgRestore()"/>
      </a>	
    </div>
...
<div id="underButton" style="display:none">
    <div id="underbannershadow" class="buttonBannerShadow">
    	<img src="/static/images//banner/under_banner_shadow.gif" width="211" height="75" /></div>
    <div id="underbanner" class="buttonBanner">
    	<img src="/static/images//banner/under_banner_a.gif" width="187" height="55" id="underImg" /></div>
    <div id="underspacer" class="buttonSpacer">
	<a href="" id="underlink">
    	<img id="underimage" src="/static/images//spacer.gif" width="187" height="55" border="0" 
    	onmouseover="MM_swapImage('underImg','','/static/images//banner/under_banner_b.gif',1); snd.playSE( cSE_Forcus );" 
    	onmouseout="MM_swapImgRestore()">
    	</a>
    </div>
  ...
  <div id="pointError" style="display:none">
    ...
    <tr>
      <td align="left" valign="middle">
        This software requires null Wii Points to download.<BR>You do not have enough Wii Points.</td>
    </tr>
    </table>
    </div>
  </div>
...
<div id="icrWarningPage">
  ...
  <div id="icrBackground">
      <img src="/static/images//banner/S_30_back.png" border="0" />
  </div>
</div>
...
<div id="details">
 <div id="Photo">
<img src="..{{ titleimageurl }}" alt="" style=" background-color:white; max-width:160px; max-height:120px; height:120px; width:160px;">
    </div>
  ...
  <div class="contentsBlackS" id="date">
    <div align="left" class="catalogTitleBlack_01">Released: <span>{{ releasedate }}</span></div>
  </div>
  <div class="catalogTitleBlack_01" id="Publisher">
    <div align="left"><span>{{ publisher }}</span></div>
  </div>
  <div id="Players">
    <div align="left" class="catalogTitleBlack_01">For <span>{{ playercount }}</span> Player(s)</div>
  </div>
  <div style="overflow:block" nowrap class="contentsBlue" id="TitleName1">
    <div align="center" class="headerBlueM"><span>{{ titlename }}</span></div>
  </div>
  <div id="Platform">
    <div align="left" class="headerWhiteS"><span>{{platform}}</span></div>
  </div>
  <div id="controller">
    <img src="/static/images//banner/controller_msg2_E_en.gif" width="77" height="65" id="Image3control" />
</div>

  <div id="controllerLink">
      <a id="ControlAnchor" href="#">
      <img src="/static/images//spacer.gif" width="77" height="65" border="0" id="Image2control" 
       onmouseover="MM_swapImage('Image3control','','/static/images//banner/controller_msg2_E_EN.gif',1);wiiFocusSound();" 
  ...
  <!-- content descriptors uses text for ESRB and OFLC, images for PEGI and CERO -->
    <div id="ESRB_Rating">
            <img src="/static/Pic_Rating/{{ titleratingcompany }}/{{ titlerating }}" 
             alt="ESRBT" width="46" height="69" />
          </div>
          <div class="style8" id="Descriptors">{{ esrbratingdesc }}</div>
          </div>
  <img src="/static/images//banner/Details.gif" width="537" height="217" />
  </div>
<!-- ordinary pricing -->
<div id="buyButton">
    <div id="buybanner"><img src="/static/images//banner/buy_a.gif" width="241" height="76" id="Image3" /></div>
    <div id="text03-01" class="buttonTextWhiteL buttonText">
      Download</div>
    <div id="price" class="buttonTextWhiteL buttonText">
        {{ costoftitle }} Wii Points</div>
    <div id="buyspacer">
      <a id="BuyAnchor" href="javascript:onBuyButtonPressed('000100014A414A45', ''), showSDSelection();">
        <img src="/static/images//spacer.gif" width="241" height="76" border="0" id="Image2" 
         onmouseover="MM_swapImage('Image3','','/static/images//banner/buy_b.gif',1);wiiFocusSound();" 
         onmouseout="MM_swapImgRestore()" 
         onclick="wiiSelectSound();"/>
      </a>
    </div>
    <div id="buyshadow">
      <img src="/static/images//banner/banner03_shadow.gif" width="274" height="90" />
    </div>
  </div>
...
<!-- gift pricing -->
<div id="buyButton" style="margin-left:260px;">
  <div id="buybanner"><img src="/static/images//banner/buy_a.gif" width="241" height="76" id="Image4" /></div>
  <div id="text03-01" class="buttonTextWhiteL giftButtonText"  style="margin-left:100px;">
    Gift</div>
  <div id="price" class="buttonTextWhiteL giftButtonText" style="margin-left:70px;">
      <span>{{ costoftitle }}</span> Wii Points</div>
  <div id="buyspacer">
    <a id="BuyAnchor" href="/404?title=">
      <img src="/static/images//spacer.gif" width="241" height="76" border="0" id="Image4" 
       onmouseover="MM_swapImage('Image4','','/static/images//banner/buy_b.gif',1);wiiFocusSound();" 
       onmouseout="MM_swapImgRestore()" 
       onclick="wiiSelectSound();"/>
    </a>
  </div>
...
<div id="downloadedMsg" style="display:none">
  <div id="buybanner2"><img src="/static/images//banner/buy_c.gif" width="290" height="42" id="Image4" /></div>
  <div id="text03-02">
...
<div id="sdbuttons" style="display:none">
  ...
  <div id="nandDLButton">
    <div id="banner01">
      <img src="/static/images//banner/sdToNAND_a.png" id="Image01" />
    </div>
    ...
    <div id="spacer01">
      <a id="NANDAnchor" href="javascript:onNANDButtonPressed('000100014A414A45', '', redownloadFlagExt)">
        <img src="/static/images//spacer.gif" name="Image01s" width="236" height="184" border="0" id="Image01s" 
        onmouseover="MM_swapImage('Image01','','/static/images//banner/sdToNAND_b.png',1);snd.playSE( cSE_Forcus );" 
  ...
  <div id="sdDLButton">
    <div id="banner02">
      <img src="/static/images//banner/sdToSD_a.png" id="Image02" />
    </div>
    ...
    <div id="spacer02">
      <a id="SDAnchor" href="javascript:onSDButtonPressed('000100014A414A45', '', redownloadFlagExt)">
        <img src="/static/images//spacer.gif" name="Image02s" width="236" height="184" border="0" id="Image02s" 
         onmouseover="MM_swapImage('Image02','','/static/images//banner/sdToSD_b.png',1);snd.playSE( cSE_Forcus );" 
         onmouseout="MM_swapImgRestore()" onclick="snd.playSE(cSE_Decide);" />
      </a>
    </div>
    <img id="sdDisable" style='display: none;' src='/static/images//banner/point_gray.png' border="0" />
  </div>
